...
public class EditarBanco extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, -1, -1));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (bander) {
            Banco u = new Banco(codAux, txtNombre.getText(), txtDirecion.getText(), BigDecimal.valueOf(Double.parseDouble(txtValor.getText())));
            controlador.edit(u);
